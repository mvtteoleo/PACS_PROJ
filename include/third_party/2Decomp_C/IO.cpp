...
void C2Decomp::writeOne(int ipencil, double* var, string filename)
{
    ...
    MPI_File_write_all(fh, var, subsizes[0] * subsizes[1] * subsizes[2], data_type,
                       MPI_STATUS_IGNORE);
...
void C2Decomp::writePlane(int ipencil, double* var, int iplane, int n, string filename)
{
    ...
    disp = 0;
    MPI_File_set_view(fh, disp, data_type, new_type, "native", MPI_INFO_NULL);
    MPI_File_write_all(fh, wk2d, subsizes[0] * subsizes[1] * subsizes[2], data_type,
                       MPI_STATUS_IGNORE);
...
void C2Decomp::writeEvery(int ipencil, double* var, int iskip, int jskip, int kskip,
