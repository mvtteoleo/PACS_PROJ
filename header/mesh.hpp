...
namespace numPDE
{
    ...
    class Mesh
    {
      ...
      public:
        ...
        {
            return std::accumulate(m_N_nodes.begin(), m_N_nodes.end(), 1ULL,
...
namespace numPDE
{
    ...
    struct Mesh
    {
      public:
        ...
        Mesh(Vector x0, VecInt nDims, T dx) : Size_dims{nDims}, X0{x0}, H{dx}, N_dims{x0.size()}
        {
            Delta_x_i.resize(N_dims, dx);
            for (size_t i = 0; i < N_dims; ++i)
