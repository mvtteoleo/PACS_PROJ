 ...
 * \mainpage Contains a template function that helps determining the corresponding MPI message data
 * type that can be found on \ref https://www.mpich.org/static/docs/latest/www3/Constants.html to a
 * constexpr. This way the code may already be simplified at compile time.
 */
